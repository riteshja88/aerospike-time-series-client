...
public class OptionsHelper {
    ...
    public static class BenchmarkerFlags {
		...
		public static final String RITESH_ALIAS = "y";
        /**
    ...
    public static class TimeUnitIndicators {
        ...
        public static final String ALL_INDICATORS = String.format("%s,%s,%s,%s or %s", YEAR, DAY, HOUR, MINUTE, SECOND);
    }
     ...
     */
    public static Options standardCmdLineOptions() {
     ...
     * @return standardCmdLineOptions
     */
    public static Options cmdLineOptionsForReader() {
        Options cmdLineOptions = new Options();

        Option hostOption = new Option(OptionsHelper.BenchmarkerFlags.HOST_FLAG, "host", true, "Aerospike seed host. Required");
        Option namespaceOption = new Option(OptionsHelper.BenchmarkerFlags.NAMESPACE_FLAG, "namespace", true, "Namespace for time series. Required.");
        Option setOption = new Option(OptionsHelper.BenchmarkerFlags.TIME_SERIES_SET_FLAG, "set", true,
                String.format("Set for time series. Defaults to %s", Constants.DEFAULT_TIME_SERIES_SET));
		...
		Option ritesh_end = new Option(OptionsHelper.BenchmarkerFlags.RITESH_END_TIME,
                "timeSeriesName", true, "Name of time series");
		Option ritesh_alias = new Option(OptionsHelper.BenchmarkerFlags.RITESH_ALIAS,
									   "timeSeriesName", true, "Name of time series");
		...
		cmdLineOptions.addOption(ritesh_alias);
        return cmdLineOptions;
    }
     ...
     */
    public static CommandLine getArguments(String[] args) throws ParseException, Utilities.ParseException {
     ...
     */
    public static int convertTimeStringToSeconds(String timeString) throws Utilities.ParseException {
        int timePart;
        int multiplier = 1;
